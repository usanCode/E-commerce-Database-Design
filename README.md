...
The PDF document  [Ecommerce Database Relationships](documents/EcommerceDatabaseRelationships.pdf) is also available in which relationships between the tables 
